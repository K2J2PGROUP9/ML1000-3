...
The objective of this work is to help Airbnb's hosts to stablish a rental price for a place, using several models of prediction.
...
In the problem identification, we all agree in the group 9 that we want to develop a tool that help Airbnb's hosts to establish a rental price for a place, using several models of prediction.
